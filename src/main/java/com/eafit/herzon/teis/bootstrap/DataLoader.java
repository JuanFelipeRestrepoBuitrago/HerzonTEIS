 ...
 * tailored to Colombian names, addresses, and Spanish jewel names.
 */
@Component
public class DataLoader implements CommandLineRunner {
   ...
   * Generates 1 admin user and 9 regular users with Colombian names and addresses,
   * jewels with Spanish names, active and ended auctions, and orders with various
   * statuses.
   *
  ...
  public void run(String... args) throws Exception {
    ...
    if (userRepository.count() == 0) {
      ...
      List<String> colombianNeighborhoods = Arrays.asList(
          "Chapinero", "El Poblado", "San Fernando", "Castillo Grande", "Getsemaní");
      ...
      for (int i = 0; i < 9; i++) {
        ...
        user.setAddress(faker.address().streetAddress() + ", " + neighborhood + ", " + city);
    ...
    if (jewelCount == 0) {
      ...
      List<String> jewelCategories = Arrays.asList(
          "Anillos", "Pulseras", "Pendientes", "Cadenas", "Dijes");
      List<String> jewelNames = Arrays.asList(
          "Anillo de oro 18k", "Pulsera de esmeraldas", "Pendientes de plata",
          "Cadena de oro con cruz", "Dije de zafiro", "Anillo de diamantes",
          "Pulsera de perlas", "Pendientes de rubíes", "Cadena con corazón",
          "Dije de esmeralda colombiana");
      Random random = new Random();
      for (int i = 0; i < 10; i++) {
        Jewel jewel = new Jewel();
        jewel.setName(jewelNames.get(random.nextInt(jewelNames.size())));
        String selectedCategory = jewelCategories.get(
            random.nextInt(jewelCategories.size()));
